    ...
    <div>
            ...
            <Columns>
              <Column className="hero_leftCol" isSize="1/2">
                ...
                <p className="hero_blurb">
                  Matching our Graduates of <br />
                  Fast-track and Gen-Tech Diplomas <br />
                  with Internship opportunities <br />
                  in Brisbane, Melbourne and Sydney
                </p>
                <Button
                  isSize={"medium"}
                  className="browseBttn"
                  href="/viewall"
                >
                  Start Browsing
                </Button>
        ...
        <Columns isCentered>
          <Column className="home_card" isSize="1/4">
            <Card>
              ...
              <CardContent>
                <Content>
                  <Title className="homeCard_title" isSize={4}>
                    Local Developers
                  </Title>
                  Proin sed tellus sed nunc luctus tristique. Curabitur dapibus
                  risus eget urna ullamcorper posuere. Quisque gravida nunc
                  porttitor pellentesque ultricies. Duis ut molestie metus, in
                  fermentum nulla. Vivamus ac porttitor magna. In ultrices
                  aliquam placerat. Nam mattis nunc turpis.{" "}
                </Content>
              </CardContent>
            </Card>
          </Column>
      ...
      <Section>
        <Columns isCentered>
          ...
          <Column isSize="1/2">
            <Content>
              <Title className="home_title" isSize={2}>
                Why Coder Academy grads?
              </Title>
              <br />
              Proin sed tellus sed nunc luctus tristique. Curabitur dapibus
              risus eget urna ullamcorper posuere. Quisque gravida nunc
              porttitor pellentesque ultricies. Duis ut molestie metus, in
              fermentum nulla. Vivamus ac porttitor magna. In ultrices aliquam
              placerat. Nam mattis nunc turpis.
              <br />
              <br />
              Proin sed tellus sed nunc luctus tristique. Curabitur dapibus
              risus eget urna ullamcorper posuere. Quisque gravida nunc
