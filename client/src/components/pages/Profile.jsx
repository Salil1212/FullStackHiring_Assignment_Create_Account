...
export default class Profile extends Component {
  ...
  componentDidMount() {
    api
      .get(`/students${this.props.location.pathname}`)
      .then((result) => {
        this.setState({
          isLoading: false,
  ...
  render() {
    ...
    if (this.state.studentData.twitterURL !== "") {
      twitter = (
        <a
          className="profile_iconLink"
          href={this.state.studentData.twitterURL}
        >
    ...
    if (this.state.studentData.linkedInURL !== "") {
      linkedIn = (
        <a
          className="profile_iconLink"
          href={this.state.studentData.linkedInURL}
        >
    ...
    if (this.state.studentData.websiteURL !== "") {
      personalWebsite = (
        <a
          className="profile_iconLink"
          href={this.state.studentData.websiteURL}
        >
    ...
    if (this.state.studentData.email !== "") {
      email = (
        <a
          className="profile_iconLink"
          href={`mailto:${this.state.studentData.email}`}
        >
          ...
          <Columns isCentered>
            <Column isSize="1/4" offset="2">
              <Gravatar
                ...
                md5={this.state.studentData.gravatar}
                size={640}
              />
              <div>
                ...
                <Title className="profile_location" isSize={5}>
                  {this.state.studentData.location}
                </Title>
                <Title isSize={6} className="profile_smalltitle">
                  Seeking
                </Title>
            ...
            <Column isSize="1/4">
              <div>
                ...
                <Tag isColor="light" isSize="medium">
                  {this.state.studentData.fieldOfInterest}
                </Tag>
              </div>
            </Column>
          </Columns>
