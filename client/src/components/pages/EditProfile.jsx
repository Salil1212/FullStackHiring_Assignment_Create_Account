...
//       studentData: {
//         ...this.state.studentData,
//         [event.target.name]: Array.from(event.target.options)
//           .filter((o) => o.selected)
//           .map((o) => o.value)[0],
//       },
//     });
...
//       "DANGER: Are you sure you want to delete your account? There is no going back!"
//     );
//     if (deleteConfirmation) {
//       api
//         .post(
//           "/students/delete-profile",
//           {
//             _id: this.state.studentData._id,
//           },
//           {
...
//         </div>
//         <div className="editProfileLeft"></div>
//         <div className="editProfileRight">
//           <div className="editProfileBox">
//             <div className="editProfile_rect"></div>

//             <Title className="editProfile_Title" isSize={2}>
//               Edit Your Profile
//             </Title>
//             <br />
...
//                         placeholder="http://..."
//                         name="websiteURL"
//                         value={this.state.studentData.websiteURL}
//                         onChange={this.handleChange}
//                       />
//                     </Control>
//                   </Field>
...
//                         name="githubURL"
//                         value={this.state.studentData.githubURL}
//                         onChange={this.handleChange}
//                       />
//                     </Control>
//                   </Field>
...
//                         name="linkedInURL"
//                         value={this.state.studentData.linkedInURL}
//                         onChange={this.handleChange}
//                       />
//                     </Control>
//                   </Field>
...
//                         name="twitterURL"
//                         value={this.state.studentData.twitterURL}
//                         onChange={this.handleChange}
//                       />
//                     </Control>
//                   </Field>
...
//                       <TextArea
//                         className="editProfileInput"
//                         placeholder="Your goals, achievements in the course, what you are interested in, the direction you want to take your career"
//                         name="bio"
//                         value={this.state.studentData.bio}
//                         onChange={this.handleChange}
//                       />
//                     </Control>
//                   </Field>
...
//                       >
//                         <option id="frontend" value="Front-End">
//                           Front-end
//                         </option>
//                         <option id="backend" value="Back-End">
//                           Back-end
//                         </option>
//                         <option id="frontBack" value="Front-End/Back-End">
//                           I like both
//                         </option>
//                       </Select>
//                     </Control>
...
//           <div>
//             <div></div>
//             <Title isSize={2}>Edit Your Profile</Title>
//             <br />
