    ...
    return (
      <Box className="profileList_entry">
        <Media>
          <MediaLeft>
            <Gravatar
              className="profileList_image"
              md5={this.props.studentData.gravatar}
              size={128}
            />
          </MediaLeft>
          <MediaContent>
            <Content className="profileList_content">
              <div>
                <Title isSize={4} className="profileList_name">
          ...
          <div className="profileList_right">
            <MediaRight>
              <div className="profileList_jobTypeList">{seeking}</div>
              <div className="profileList_viewProfile">
                <Button
                  className="profileList_viewProfileBttn"
                  studentData={this.props.studentData}
                  href={`/profile/${this.props.studentData._id}`}
                >
                  View Profile
                </Button>
              </div>
